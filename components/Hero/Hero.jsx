...
const Hero = () => {
  return (
    <>
      <main className="flex w-full flex-col items-center hero-bg"
            //  style={{
      ...
      >
        ...
        <div className="flex w-7/12 justify-center min-h-[600px] gap-8 flex-col items-center">
          <h1 className="text-7xl flex flex-wrap gap-4 justify-center text-[#01000A] leading-[70px] font-bold text-center">
            Manage Your <span className="text-[#4B4EFC]">
            <Image 
              src={'https://res.cloudinary.com/dmbsct2bo/image/upload/v1696330709/Component_2_iksr4g.png'}
              width={150}
              height={150}
              alt="inline-tag"
              className=""
            ...
            Team&apos;s <span className="text-[#4B4EFC] flex items-center ">
              <Image 
              src={'https://res.cloudinary.com/dmbsct2bo/image/upload/v1696330006/Component_1_1_bkwlud.png'}
              width={200}
              height={200}
              alt="inline-tag"
              className=""
      ...
      <span className="text-[#0c05eb] underline word">Productivity</span>
